...
<nav class="navbar opacity">
    <div class="container-fluid">
        ...
        <!-- ICON USER NAME -->
        <div class="nav_icons">
            <div class="user_profile"><a href="#" ><img src="../images/user.png" alt="" width=" 100%"></a> <span ><?=$FirstName?></span></div>
...
<div class="container-card" id="<?=$post["post_id"]?>">
    ...
    <div class="container_comments">
        <button class= "view_more" style="cursor:pointer">View all comments</button>
        <?php    
